...
/**@file download_client_speedtest.h
 *
 * @defgroup dl_client Download client for speedtest program
 * @{
...
#ifndef DOWNLOAD_CLIENT_SPEEDTEST_H__
#define DOWNLOAD_CLIENT_SPEEDTEST_H__

#include <zephyr.h>
#include <zephyr/types.h>
#include <net/coap.h>

/* Specified here as these are no longer defined in prj.conf */
...
#define DOWNLOAD_CLIENT_SPEEDTEST_LOG_LEVEL 1

#define USE_SEC_TAG_ARRAY /* MQ  Allow download_client_speedtest lib to accept array of security tags instead of just one. */
...
#ifdef USE_SEC_TAG_ARRAY	
	/** Configuration options. */
	/* MQ moved to end of structure as download_client_cfg has a flexible array member thus required by C99 to be at the end of the all enclosing superstructures. */
	struct download_client_cfg config;
#endif
};
...
#endif /* DOWNLOAD_CLIENT_SPEEDTEST_H__ */
